...
@UseTestDataFrom(value = Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Dynamic_Widget_Chart.csv", separator=',')

public class Bmo5_Adm_DvPacks_CreateDvPack_Dynamic_Widget_Chart extends TestCase{
	...
	createDynamicDvPackPageBreadcrumbs, region, startDateOperator, startYear, endDateOperator, endYear, status, sector, fromValue, toValue, fromEstPeakOil, toEstPeakOil, fromEstPeakGas, toEstPeakGas,
	...
	editDvPackPageBreadcrumbs, renderType, dvPackSubTitle, expectedDvPackSubtitle,geography, channel,databaseTable,rowNumber,expectedDvPacknameClone,expectedDvPackTitleClone;
	private static int line = 0;
	
	@Test
	public void bmo5_Adm_DvPacks_CreateDvPack_Dynamic_Widget_Chart(){
...
//			adm_DvPacks_CreateDvPack_GeneralSteps.verifyButtonsPresenceForDynamicDvPack();
			...
			dvPackId = adm_Dvpacks_PreviewAndAprove_GeneralSteps.getDvpackIDConfirmationPage(Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Dynamic_Widget_Chart.csv", line);
