...
@UseTestDataFrom(value = Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Dynamic_Widget_Table.csv", separator=',')

public class Bmo5_Adm_DvPacks_CreateDvPack_Dynamic_Widget_Table extends TestCase{
	...
	editDvPackPageBreadcrumbs, renderType,geography, channel,databaseTable,countryColumn, row, annotationDescription, rowNumber, expectedDvPacknameClone, 
	...
	@Test
	public void bmo5_Adm_DvPacks_CreateDvPack_Dynamic_Widget_Table(){
		...
		dvPackId = adm_Dvpacks_PreviewAndAprove_GeneralSteps.getDvpackIDConfirmationPage(Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Dynamic_Widget_Table.csv", line);
