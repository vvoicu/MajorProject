...
@UseTestDataFrom(value = Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Static_System_Chart.csv", separator=',')

public class Bmo5_Adm_DvPacks_CreateDvPack_Static_System_Chart extends TestCase{
	...
	confirmationpageBreadcrumbs, dvPackId, dvPackType, type, defaultView, editDvPackPageBreadcrumbs, renderType, dvPackSubTitle, expectedDvPackSubtitle, databaseTable,
	textAnnotationType, size, description, rotation, newDescription, newSize, newRotation, arrowAnnotationType, lineType, newLineType, lineAnnotationType, rowNumber,
	...
	@Test
	public void bmo5_Adm_DvPacks_CreateDvPack_Static_System_Chart(){
...
//			adm_DvPacks_CreateDvPack_GeneralSteps.verifyButtonsPresenceForStaticDvPAck();
			...
			dvPackId = adm_Dvpacks_PreviewAndAprove_GeneralSteps.getDvpackIDConfirmationPage(Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Static_System_Chart.csv", line);
