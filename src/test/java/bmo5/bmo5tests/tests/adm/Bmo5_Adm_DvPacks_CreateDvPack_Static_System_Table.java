...
@UseTestDataFrom(value = Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Static_System_Table.csv", separator=',')

public class Bmo5_Adm_DvPacks_CreateDvPack_Static_System_Table extends TestCase{
	...
	createStatiDvPackPageBreadcrumbs, region, startDateOperator, startYear, endDateOperator, endYear, status, sector, fromValue, toValue, fromEstPeakOil, toEstPeakOil, fromEstPeakGas, 
	...
	confirmationpageBreadcrumbs, dvPackId, dvPackType, type, defaultView, editDvPackPageBreadcrumbs, renderType, databaseTable,
	textAnnotationType, size, description, rotation, newDescription, newSize, newRotation, arrowAnnotationType, lineType, newLineType, lineAnnotationType, rowNumber, countryEdit, 
	...
	ageEdit, genderEdit, expectedDvPacknameClone, expectedDvPackTitleClone;
	public int expectedNumberOfRowsFromTable;
	private static int line = 0;
	
	@Test
	public void bmo5_Adm_DvPacks_CreateDvPack_Static_System_Table(){
...
//		adm_DvPacks_CreateDvPack_GeneralSteps.clickOnClearFiltersButtonAndVerify();
		...
		dvPackId = adm_Dvpacks_PreviewAndAprove_GeneralSteps.getDvpackIDConfirmationPage(Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Static_System_Table.csv", line);
...
//		adm_DvPacks_Listing_GeneralSteps.checkTableIntoListView("di8Yf1sKtr", "NDB_Name3115", "NDB_Title501", "system", "Table", "NDB", "Static");
