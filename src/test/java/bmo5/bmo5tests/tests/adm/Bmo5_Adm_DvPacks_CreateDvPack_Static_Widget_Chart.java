...
@UseTestDataFrom(value = Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Static_Widget_Chart.csv", separator=',')

public class Bmo5_Adm_DvPacks_CreateDvPack_Static_Widget_Chart extends TestCase{
	...
	editDvPackPageBreadcrumbs, renderType, dvPackSubTitle, expectedDvPackSubtitle,geography, channel,databaseTable,countryColumn, row, annotationDescription,column, annotationDescriptionColumn,newRowDescription, 
	deleteRow,newCellDescription, deleteCell,arrowAnnotationType, lineType,newLineType,lineAnnotationType,rowNumber,expectedDvPacknameClone, expectedDvPackTitleClone, countryEdit, indicatorEdit, dateRangeFromEdit, dateRangeToEdit, regionEdit, operatorEdit, ageEdit, genderEdit;
	 private static int line = 0;
	
	@Test
	public void bmo5_Adm_DvPacks_CreateDvPack_Static_Widget_Chart(){
		...
		if(database.equals("NDB") || database.equals("Mobile Operators") || database.equals("Burden of Disease")){
			...
			adm_DvPacks_CreateDvPack_GeneralSteps.verifyTableWithAnnotation(row,deleteRow, annotationDescription, column, annotationDescriptionColumn);
			...
			dvPackId = adm_Dvpacks_PreviewAndAprove_GeneralSteps.getDvpackIDConfirmationPage(Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Static_Widget_Chart.csv", line);
