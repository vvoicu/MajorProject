...
@UseTestDataFrom(value = Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Template_System_Chart.csv", separator=',')

public class Bmo5_Adm_DvPacks_CreateDvPack_Template_System_Chart extends TestCase {
	...
	confirmationpageBreadcrumbs, dvPackId, dvPackType, type, defaultView, editDvPackPageBreadcrumbs, renderType, databaseTable, dvPackSubTitle, expectedDvPackSubtitle, rowNumber, 
	expectedDvPacknameClone, expectedDvPackTitleClone, countryEdit, indicatorEdit, dateRangeFromEdit, dateRangeToEdit, regionEdit, ageEdit, genderEdit;
	public int expectedNumberOfRowsFromTable;
	private static int line = 0;
	
	@Test
	public void bmo5_Adm_DvPacks_CreateDvPack_Template_System_Chart(){
		...
		if(database.equals("NDB") || database.equals("Burden of Disease")){
...
//			adm_DvPacks_CreateDvPack_GeneralSteps.verifyButtonsPresenceForDynamicDvPack();
			...
			adm_DvPacks_CreateDvPack_GeneralSteps.clickOnFormatChartAndVerifyForTemplate(expectedDvPackTitle, expectedDvPackSubtitle, expectedDvPackDescription,dvPackType);
			...
			adm_Dvpacks_PreviewAndAprove_GeneralSteps.verifySubtitleFromPreview(expectedDvPackSubtitle);
			...
			dvPackId = adm_Dvpacks_PreviewAndAprove_GeneralSteps.getDvpackIDConfirmationPage(Constants.ADM_RESOURCES_PREFIX + "Bmo5_Adm_DvPacks_CreateDvPack_Template_System_Chart.csv", line);
