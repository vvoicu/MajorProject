...
@Story(Application.Enterprise.Children.Header.MyBMO.Account.CostCodes.class)
@RunWith(ThucydidesParameterizedRunner.class)
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX	+ "Test_001_Enterprise_ChildAccount_CostCodes.csv", separator = ',')

public class Test_001_Enterprise_ChildAccount_CostCodes extends TestCase {
	...
	String username, password,breadcrumb,nameFour,button,logout,account,accountTitle,costCodes,myCostCodes,message,mandatoryCCMessage,nameOne, nameTwo, nameThree,userChild, passChild,news,labelO,labelT,labelTh,labelF,labelOneName, labelTwoName, labelThreeName, labelFourName, costCodeNameF, costCodeNameS, costCodeNameT, costCodeNameFo;
	...
	@Test
	public void test_001_Enterprise_ChildAccount_CostCodes() { 
		...
		clientAccountSteps.setCostCodesSection(costcodes, ccname, label1, label2, label3, label4);
		...
		createChildAccountSteps.loginFromEnterprise(userChild,passChild);
