...
@Story(Application.Enterprise.Header.MyBMO.Account.CostCodes.class)
@RunWith(ThucydidesParameterizedRunner.class)
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX	+ "Test_001_Enterprise_CostCodes.csv", separator = ',')

public class Test_001_Enterprise_CostCodes extends TestCase {
	...
	@Test
	public void test_001_Enterprise_CostCodes() { 
		...
		clientAccountSteps.selectTypeForUser(type);
		Sleeper.sleepTight(2000);
		clientAccountSteps.saveUserDetails();
		Sleeper.sleepTight(4000);
		clientAccountSteps.verifyTypeWasSelected(type);
