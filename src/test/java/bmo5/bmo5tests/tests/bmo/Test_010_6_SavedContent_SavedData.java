...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_010_6_SavedContent_SavedData.csv", separator=',')

public class Test_010_6_SavedContent_SavedData extends TestCase {
	...
	public void setSavedArticleNumber(int savedDataNumber) {
		this.savedDataNumber = savedDataNumber;
	}
	...
	@Test
	public void test_010_6_SavedContent_SavedData(){
...
//		savedArticlesSavedDataSteps.moveToFolder(newFolderName, savedDataNumber); // this step fails
		...
		savedArticlesSavedDataSteps.checkOneItemFromListing(savedDataNumber);
