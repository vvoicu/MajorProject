...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_011_2_StrategicAnalysisAndReportsStrategicAnalysisPreviewArticle_Phase2.csv", separator=',')

public class Test_011_2_StrategicAnalysisAndReportsStrategicAnalysisPreviewArticle_Phase2 extends TestCase {
	...
	public String username, password,breadcrumb, articleName, parentBreadcrumb;
	...
	@Test
	public void test_011_2_StrategicAnalysisAndReportsStrategicAnalysisPreviewArticle_Phase2() {
...
//		articleName = previewArticleWindowSteps.getArticleNameFromPreviewWindow();
		...
		//TODO fix this
//		previewArticleWindowSteps.clickOnViewFullReportIconPreviewArticle(articleName); // The report name is different from article`s name
