...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_011_3_StrategicAnalysisAndReportsStategicAnalysisArticlePage_Phase2.csv", separator=',')

public class Test_011_3_StrategicAnalysisAndReportsStategicAnalysisArticlePage_Phase2 extends TestCase {
	...
	public String username, password, parentBreadcrumb,breadcrumb,articleName;
	...
	@Test
	public void test_011_3_StrategicAnalysisAndReportsStategicAnalysisArticlePage_Phase2() {
		...
		//TODO fix this
//		singleArticleSteps.clickOnViewFullReportButtonArticle();
