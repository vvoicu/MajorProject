...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX
		+ "Test_057_13_Chart_Edit_Line_Annotation.csv", separator = ',')


public class Test_057_13_Chart_Edit_Line_Annotation extends TestCase{
	...
	public String username, password, geography, indicator, dateRanges, filePath, annotationType, textSize,dataTool, rotation, description, newTextSize, newRotation, newDescription, lineType, newLineType;
	...
	@Test
	public void test_057_13_Chart_Edit_Line_Annotation() {
