...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX
		+ "Test_057_16_Table_Add_New_Cell_Annotation.csv", separator = ',')


public class Test_057_16_Table_Add_New_Cell_Annotation extends TestCase{
	...
	public String username, password, geography, indicator, dateRanges, annotationType, description, row, column, dataTool;
	...
	@Test
	public void test_057_16_Table_Add_New_Cell_Annotation() {
