...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX
		+ "Test_057_20_Table_Edit_Row_Annotation.csv", separator = ',')


public class Test_057_20_Table_Edit_Row_Annotation extends TestCase{
	...
	@Test
	public void test_057_20_Table_Edit_Row_Annotation() {
		...
		dataToolSteps.tableAddAndVerifyEditedRowAnnotationList(annotationType,description,row,column);		
	}
}