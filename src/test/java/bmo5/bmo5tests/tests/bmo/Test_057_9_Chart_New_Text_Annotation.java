...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX
		+ "Test_057_9_Chart_New_Text_Annotation.csv", separator = ',')


public class Test_057_9_Chart_New_Text_Annotation extends TestCase{
	...
	public String username, password, geography, indicator, dateRanges, filePath, annotationType, textSize, rotation, description,Selectedindicator, dataTool;
	...
	@Test
	public void test_057_9_Chart_New_Text_Annotation() {
