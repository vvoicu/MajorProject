...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_060_10_BMIDatabases_DvPacks_Chart_Print.csv", separator = ',')

public class Test_060_10_BmiDatabases_DvPacks_Chart_Print extends TestCase {
	...
	public String username, password, databaseName,geography,operator,indicator,year,gender,age, bmiDatabasesBreadcrumbs;
	int statusNumber;
	...
	@Test
	public void test_060_10_BMIDatabases_DvPacks_Chart_Print() {
