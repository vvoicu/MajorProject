...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_060_14_BMIDatabases_DvPacks_Chart_Edit_Text_Annotation.csv", separator = ',')

public class Test_060_14_BmiDatabases_DvPacks_Chart_Edit_Text_Annotation extends TestCase {
	...
	public String username,password,databaseName,geography,operator,indicator,year,gender,age,annotationType,textSize,rotation,description,newTextSize,newRotation,newDescription,bmiDatabasesBreadcrumbs;
	int statusNumber;
	...
	@Test
	public void test_060_14_BMIDatabases_DvPacks_Chart_Edit_Text_Annotation() {
