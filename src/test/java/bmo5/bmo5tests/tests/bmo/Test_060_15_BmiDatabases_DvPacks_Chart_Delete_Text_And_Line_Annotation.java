...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_060_15_BmiDatabases_DvPacks_Chart_Delete_Text_And_Line_Annotation.csv", separator = ',')

public class Test_060_15_BmiDatabases_DvPacks_Chart_Delete_Text_And_Line_Annotation extends TestCase {
	...
	public String username,password,databaseName,geography,operator,indicator,year,gender,age,annotationType,textSize,rotation,description,annotationTypeLine,lineType,bmiDatabasesBreadcrumbs;
	int statusNumber;
	...
	@Test
	public void test_060_15_BmiDatabases_DvPacks_Chart_Delete_Text_And_Line_Annotation() {
		...
		dataToolSteps.deleteAnnotationFromListAndEditWindow(annotationType,annotationTypeLine,textSize,rotation,description,lineType);
