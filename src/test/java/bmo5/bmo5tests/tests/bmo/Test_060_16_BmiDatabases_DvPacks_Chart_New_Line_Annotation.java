...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_060_16_BMIDatabases_DvPacks_Chart_New_Line_Annotation.csv", separator = ',')

public class Test_060_16_BmiDatabases_DvPacks_Chart_New_Line_Annotation extends TestCase {
	...
	public String username,password,databaseName,geography,operator,indicator,year,gender,age,annotationType,lineType,rotation,description,bmiDatabasesBreadcrumbs;
	int statusNumber;
	...
	@Test
	public void test_060_16_BMIDatabases_DvPacks_Chart_New_Line_Annotation() {
