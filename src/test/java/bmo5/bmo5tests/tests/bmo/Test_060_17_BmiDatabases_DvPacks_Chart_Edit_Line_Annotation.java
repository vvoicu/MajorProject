...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_060_17_BMIDatabases_DvPacks_Chart_Edit_Line_Annotation.csv", separator = ',')

public class Test_060_17_BmiDatabases_DvPacks_Chart_Edit_Line_Annotation extends TestCase {
	...
	public String username,password,databaseName,geography,operator,indicator,year,gender,age,annotationType,lineType,newLineType,bmiDatabasesBreadcrumbs;
	int statusNumber;
...
//	}
	...
	@Test
	public void test_060_17_BMIDatabases_DvPacks_Chart_Edit_Line_Annotation() {
		...
		dataToolSteps.editAndVerifyChartLineAnnotation(annotationType,lineType,newLineType);
