...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_060_19_BMIDatabases_DvPacks_Chart_Format.csv", separator = ',')

public class Test_060_19_BmiDatabases_DvPacks_Chart_Format extends TestCase {
	...
	public String username,password,databaseName,geography,operator,indicator,year,gender,age,title,subtitle,formatDescription,chartType,indicatorSeries,seriesType,bmiDatabasesBreadcrumbs;
	int statusNumber;
	...
	@Test
	public void test_060_19_BMIDatabases_DvPacks_Chart_Format() {
