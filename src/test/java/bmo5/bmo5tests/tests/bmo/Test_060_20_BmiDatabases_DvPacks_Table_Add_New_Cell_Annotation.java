...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_060_20_BMIDatabases_DvPacks_Table_Add_New_Cell_Annotation.csv", separator = ',')

public class Test_060_20_BmiDatabases_DvPacks_Table_Add_New_Cell_Annotation extends TestCase {
	...
	public String username,password,databaseName,geography,operator,indicator,year,gender,age,sindicator,tindicator,annotationType,description,row,column, bmiDatabasesBreadcrumbs, sector,
	fuelType, renewable;
	int statusNumber;
	...
	@Test
	public void test_060_20_BMIDatabases_DvPacks_Table_Add_New_Cell_Annotation() {
