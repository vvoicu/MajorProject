...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX	+ "Test_066_Adm_Bmo_CostCodes.csv", separator = ',')

public class Test_066_Adm_Bmo_Mandatory_CostCodes extends TestCase {
	...
	@Test
	public void test_066_Adm_Bmo_CostCodes() {
