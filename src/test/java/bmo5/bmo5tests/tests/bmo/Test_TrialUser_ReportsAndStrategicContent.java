...
@Story(Application.Trial.Pillars.ReportsAndStrategicContent.class)
@RunWith(ThucydidesParameterizedRunner.class)
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_TrialUser_ReportsAndStrategicContent.csv", separator = ',')

public class Test_TrialUser_ReportsAndStrategicContent extends TestCase {
	...
	@Qualifier
	 public String getQualifier() {
       return reportsAndStrategicContentBreadcrumbs;
   }
	...
	@Test
	public void test_TrialUser_ReportsAndStrategicContent() {
