...
@Story(Application.Trial.Pillars.ReportsAndStrategicContent.ReportsArchive.class)
@RunWith(ThucydidesParameterizedRunner.class)
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_TrialUser_ReportsArchive.csv", separator = ',')

public class Test_TrialUser_ReportsArchive extends TestCase {
	...
	@Qualifier
	 public String getQualifier() {
       return reportsArchiveBreadcrumbs;
   }
	...
	@Test
	public void test_TrialUser_ReportsArchive() {
