...
@UseTestDataFrom(value = Constants.BMO_RESOURCES_PREFIX + "Test_TrialUser_Widgets.csv", separator=',')

public class Test_TrialUser_Widgets{
	...
	@Test
	public void test_TrialUser_Widgets(){
	    ...
	    if(contextType.equals("Details")&&!contentType.equals("Reports")){
	...
	//	manageWidgetsSteps.selectSlot(slot);
		...
		bmo5LoginSteps.performLogin(username, password);	
		//TODO fix this
//		businessRulesWidgetsSteps.clickOnSelectedPage(page,pivotPoint, pivotName, continent, otherRating,analysis,news, itemNumber, contentType,subContextType, serviceLeftHandFilter, geographyLeftHandFilter,subPageName,countryId, articleTypeNumber, articleId,reportIssueNumber);
	  ...
	  if(page.contains("Preview")){
			...
			businessRulesWidgetsSteps.clickFirstArticleAndCheckDownloadAndPrintButtonForTrial(widgetContainerPreview,savedTitle, widgetId,contentType);
			//TODO fix this
//			businessRulesWidgetsSteps.clickOnSelectedPage(page,pivotPoint, pivotName, continent, otherRating,analysis,news, itemNumber, contentType,subContextType, serviceLeftHandFilter, geographyLeftHandFilter,subPageName,countryId, articleTypeNumber, articleId,reportIssueNumber);
			businessRulesWidgetsSteps.clickDownloadButtonForReportWidgetTrialUser(widgetContainer, savedTitle, contentType, widgetId);
			if(viewMore.equals("1")&&(Integer.parseInt(slotsTo)-Integer.parseInt(slotsFrom)>=5)){
				//TODO fix this
//				businessRulesWidgetsSteps.clickViewMoreButtonAndVerifyDownloadAndPrintForTrial(widgetContainerPreview,savedTitle,contentType,widgetId);
					}
			...
			businessRulesWidgetsSteps.clickDownloadButtonForReportWidgetTrialUser(widgetContainer, savedTitle, contentType, widgetId);
			businessRulesWidgetsSteps.clickFirstArticleAndCheckDownloadAndPrintButtonForTrial(widgetContainer,savedTitle, widgetId,contentType);
...
//				businessRulesWidgetsSteps.clickOnSelectedPage(page,pivotPoint, pivotName, continent, otherRating,analysis,news, itemNumber, contentType,subContextType, serviceLeftHandFilter, geographyLeftHandFilter,subPageName,countryId, articleTypeNumber, articleId,reportIssueNumber);
			...
			if(viewMore.equals("1")&&(Integer.parseInt(slotsTo)-Integer.parseInt(slotsFrom)>=5)){
				//TODO fix this
//				businessRulesWidgetsSteps.clickViewMoreButtonAndVerifyDownloadAndPrintForTrial(widgetContainer,savedTitle,contentType,widgetId);
						}
					}
				}
			...
			businessRulesWidgetsSteps.clickDownloadButtonForReportWidgetTrialUser(widgetContainerSAR, savedTitle, contentType, widgetId);
			businessRulesWidgetsSteps.clickFirstArticleAndCheckDownloadAndPrintButtonForTrial(widgetContainerSAR,savedTitle, widgetId, contentType);
			if(pivotPoint.equals("General")){
				//TODO fix this
//				businessRulesWidgetsSteps.clickOnSelectedPage(page,pivotPoint, pivotName, continent, otherRating,analysis,news, itemNumber, contentType,subContextType, serviceLeftHandFilter, geographyLeftHandFilter,subPageName,countryId, articleTypeNumber, articleId,reportIssueNumber);
			}else{
			...
			if(viewMore.equals("1")&&(Integer.parseInt(slotsTo)-Integer.parseInt(slotsFrom)>=5)){
				//TODO fix this
//				businessRulesWidgetsSteps.clickViewMoreButtonAndVerifyDownloadAndPrintForTrial(widgetContainerSAR,savedTitle,contentType,widgetId);
					}
				}
